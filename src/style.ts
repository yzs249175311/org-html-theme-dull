export default (function(){
	...
	setStyleAll("#content h1:not(.title)", "text-5xl my-4 z-10 shadow pl-4")
	setStyleAll("#content h2", "text-4xl my-4 z-10 shadow pl-4  min-h-[3rem]")
	setStyleAll("#content h3", "text-3xl my-4 z-10 shadow  pl-4 min-h-[3rem]")
	setStyleAll("#content h4", "text-2xl my-4 z-10 shadow pl-4  min-h-[3rem]")
	setStyleAll("#content h5", "text-xl my-4 z-10 shadow pl-4   min-h-[3rem]")
	setStyleAll("#content h6", "text-lg my-4 z-10 shadow  pl-4  min-h-[3rem]")

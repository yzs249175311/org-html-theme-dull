export default (function(){
	...
	setStyleAll("#table-of-contents", "z-20 fixed top-8 right-4 border rounded-lg p-4 pt-0 shadow-lg center max-h-[80%] max-w-2xs hover:max-w-fit overflow-x-hidden overflow-y-auto transition-transform translate-x-[120%] xl:translate-x-0")
